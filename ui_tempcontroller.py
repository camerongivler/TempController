...
#
# Created: Tue Nov 17 01:24:08 2015
...
class Ui_TempController(object):
    def setupUi(self, TempController):
        ...
        self.warningThresholdButton = QtWidgets.QPushButton(self.frame_3)
        self.warningThresholdButton.setObjectName("warningThresholdButton")
        self.horizontalLayout_8.addWidget(self.warningThresholdButton)
    ...
    def retranslateUi(self, TempController):
        ...
        self.label.setText(_translate("TempController", "Warning Email:"))
        self.warningThresholdButton.setText(_translate("TempController", "Set Threshold"))
