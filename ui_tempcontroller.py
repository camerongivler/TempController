...
class Ui_TempController(object):
    def setupUi(self, TempController):
        ...
        self.exportField = QtWidgets.QLineEdit(self.groupBox_5)
        self.exportField.setObjectName("exportField")
        self.horizontalLayout_5.addWidget(self.exportField)
        self.exportButton = QtWidgets.QPushButton(self.groupBox_5)
    ...
    def retranslateUi(self, TempController):
        ...
        self.exportField.setPlaceholderText(_translate("TempController", "tempData.csv"))
        self.exportButton.setText(_translate("TempController", "Export"))
